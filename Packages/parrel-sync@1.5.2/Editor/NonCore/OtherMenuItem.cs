namespace ParrelSync.NonCore
{
    ...
    {
        [MenuItem("工具/ParrelSync/GitHub/View this project on GitHub", priority = 10)]
        private static void OpenGitHub()
        {
            Application.OpenURL(ExternalLinks.GitHubHome);
        }

        [MenuItem("工具/ParrelSync/GitHub/View FAQ", priority = 11)]
        private static void OpenFAQ()
        {
            Application.OpenURL(ExternalLinks.FAQ);
        }

        [MenuItem("工具/ParrelSync/GitHub/View Issues", priority = 12)]
