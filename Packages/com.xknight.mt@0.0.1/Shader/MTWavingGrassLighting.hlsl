#ifndef __MT_WAVING_GRASS_LIGHTING__
#define __MT_WAVING_GRASS_LIGHTING__
...
half3 LightingPhysicallyBasedTransluenct(
...
{
    return LightingPhysicallyBasedTransluenct(
...
half4 FragmentTransluentPBR(InputData inputData, SurfaceData surfaceData)
{
    ...
    {
        lightingData.mainLightColor = LightingPhysicallyBasedTransluenct(
            brdfData, brdfDataClearCoat,
            mainLight,
    ...
    for (uint lightIndex = 0; lightIndex < min(_AdditionalLightsDirectionalCount, MAX_VISIBLE_LIGHTS); lightIndex++)
    {
        ...
        {
            lightingData.additionalLightsColor += LightingPhysicallyBasedTransluenct(
...
#endif //__MT_WAVING_GRASS_LIGHTING__
