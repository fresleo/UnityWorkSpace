#ifndef __URP_MT_TERRAIN_LIT_PASSES__
#define __URP_MT_TERRAIN_LIT_PASSES__
...
void InitializeInputData(Varyings IN, half3 normalTS, out InputData input)
{
    ...
    // NOTE SAMPLE_GI 会调用 SampleSHPixel 函数，这个函数有问题，手机上使用的是 EVALUATE_SH_MIXED 宏
    // pc 使用的是 EVALUATE_SH_VERTEX
...
#endif //__URP_MT_TERRAIN_LIT_PASSES__
