...
using com.xknight.mt.Lib.Runtime.TriangleNet.Algorithm;
using com.xknight.mt.Lib.Runtime.TriangleNet.Data;
using com.xknight.mt.Lib.Runtime.TriangleNet.Geometry;
using com.xknight.mt.Lib.Runtime.TriangleNet.IO;
using com.xknight.mt.Lib.Runtime.TriangleNet.Log;
using com.xknight.mt.Lib.Runtime.TriangleNet.Smoothing;
using com.xknight.mt.Lib.Runtime.TriangleNet.Tools;

namespace com.xknight.mt.Lib.Runtime.TriangleNet
{
    /// <summary>
    /// Mesh data structure.
    /// </summary>
    public class Mesh
    {
        ...
        public Dictionary<int, Triangle> triangles; //为了方便外部访问 internal -> public 
