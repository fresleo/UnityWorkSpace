...
namespace GraphProcessor
{
	...
	public class BaseGraph : SerializedScriptableObject
	{
		...
		public void OnGraphDisable()
		{
			...
			{
				nodeItem.DisableInternal();
			}
		}

		protected void InitializeGraphElements()
		{
			...
			foreach (var node in nodes.ToList())
			{
				...
				t_index = node.intGUID;
			}
			
			idGen = new NodeFlowIdGen(t_index + 1);
...
#pragma warning restore CS0618
		...
		public virtual bool BeforeGraphSave()
		{
			return true;
		}
