...
namespace GraphProcessor
{
	...
	public class NodePort
	{
		...
		public void Add(SerializableEdge edge)
		{
			...
			edge.outputNode.OnOutPortEdgeAdded(edge.inputNode, edge.outputFieldName);
			edge.inputNode.OnInPortEdgeAdded(edge.outputNode, edge.outputFieldName);
		}
...
// We keep slow checks inside the editor
		...
		public void Remove(SerializableEdge edge)
		{
			...
			edge.outputNode.OnOutPortEdgeRemoved(edge.inputNode, edge.outputFieldName);
			edge.inputNode.OnInPortEdgeRemoved(edge.outputNode, edge.outputFieldName);
		}
	...
	public abstract class NodePortContainer : List< NodePort >
	{
		...
		public void Add(SerializableEdge edge)
		{
			...
			if (port == null)
			{
				Debug.LogError($"The edge can't be properly connected because it's ports can't be found. portFieldName = {portFieldName}");
				return;
			}
