...
namespace GraphProcessor
{
	...
	public abstract class BaseNode
	{
		...
		public abstract void AutoGenNodeId(BaseGraph baseGraph);

		public abstract object GetNodeParam();

		public abstract List<int> GetNodeInPort();
		
		public abstract List<int> GetNodeOutPort();
		
		public abstract List<int> GetNodeChildrenOutPort();
		...
		public virtual void OnInPortEdgeAdded(BaseNode inNode, string outputFieldName)
		{
			
		}

		public virtual void OnInPortEdgeRemoved(BaseNode inNode, string outputFieldName)
		{
			
		}

		public virtual void OnOutPortEdgeAdded(BaseNode outNode, string outputFieldName)
		{
			
		}
		
		public virtual void OnOutPortEdgeRemoved(BaseNode outNode, string outputFieldName)
		{
