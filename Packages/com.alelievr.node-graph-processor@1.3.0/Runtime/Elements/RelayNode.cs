...
public class RelayNode : BaseNode
{
	...
	public override void AutoGenNodeId(BaseGraph baseGraph)
	{
		
	}

	public override object GetNodeParam()
	{
		return null;
	}

	public override List<int> GetNodeInPort()
	{
		return new List<int>();
	}

	public override List<int> GetNodeOutPort()
	{
		return new List<int>();
	}

	public override List<int> GetNodeChildrenOutPort()
	{
		return new List<int>();
	}
