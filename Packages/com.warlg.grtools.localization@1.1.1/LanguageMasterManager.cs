...
namespace GRTools.Localization
{
    ...
    public class LocalizationInfo
    {
        ...
        public string TextAssetPath = "OutputRes/tabledata/";

        public string AssetsPath = "fonts/TMPFont/";


        public LocalizationInfo(SystemLanguage languageType = SystemLanguage.Unknown, string textAssetPath = null,
    ...
    public partial class LanguageMasterManager
    {
        ...
        public static LanguageMasterManager Singleton
        {
            get
            {
                if (_singleton == null)
                    _singleton = new LanguageMasterManager();
                return _singleton;
            }
        }
        ...
        private static LanguageMasterManager _singleton;
        ...
        private Dictionary<long, string> _localDict;
        
        
        public void Init(ILocalizationLoader assetLoader, ILocalizationParser assetParser,
            bool followSystem = true, SystemLanguage defaultLanguage = SystemLanguage.ChineseSimplified)
        {
            ...
            ILocalizationParser assetParser = null, Action<bool> completed = null)
        {
...
#if UNITY_EDITOR
            if (PlayerPrefs.HasKey(KLocalizeKey))
            {
                Debug.Log("清除多语言缓存！！！");
            ...
            SystemLanguage savedLanguageType = (SystemLanguage) PlayerPrefs.GetInt(KLocalizeKey,(int)_defaultLanguage);
        ...
        private void LoadLocalizationDict(LocalizationInfo info, Action<bool> completed)
        {
            ...
            {
                Dictionary<long, string> dict = Parser.Parse(asset);
                if (dict != null)
                {
                    if (_localDict != null)
                    {
        ...
        /// </param>
        /// <returns></returns>
        public string GetLocalizedText(long key, string defaultText = "输入KEY无效")
        {
