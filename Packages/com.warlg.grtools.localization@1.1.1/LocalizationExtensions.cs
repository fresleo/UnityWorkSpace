...
namespace GRTools.Localization
{
    public partial class LanguageMasterManager
    {
        ...
        /// default language
        /// </param>
        public void Init(SystemLanguage defaultLanguage = SystemLanguage.ChineseSimplified,LocalizationTextType textType = LocalizationTextType.Bytes, bool followSystem = true)
        {
#if !UNITY_EDITOR
            defaultLanguage = SystemLanguage.ChineseSimplified;//GetDefaultLan(Application.systemLanguage);
#elif UNITY_EDITOR
            defaultLanguage = GetDefaultLan(defaultLanguage);
#endif            
            Init( new LocalizationXKAssetLoader(), new LocalizationDefaultParser(textType), followSystem, defaultLanguage);
        }

        private static SystemLanguage GetDefaultLan(SystemLanguage language)
        {
        ...
        /// default language
        /// </param>
        // public static void Init(ILocalizationLoader assetLoader, LocalizationTextType textType = LocalizationTextType.Bytes, bool followSystem = true, SystemLanguage defaultLanguage = SystemLanguage.ChineseSimplified)
        // {
