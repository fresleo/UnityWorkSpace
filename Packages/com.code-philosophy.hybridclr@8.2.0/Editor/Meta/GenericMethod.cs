...
namespace HybridCLR.Editor.Meta
{
    public class GenericMethod
    {
        ...
        {
            return KlassInst != null || MethodInst != null;
        }

        public TypeSig GetFinalReturnType()
        {
            var gac = new GenericArgumentContext(KlassInst, MethodInst);
            return gac.Resolve(Method.ReturnType);
        }

        public TypeSig GetFinalParam(int index)
        {
            var gac = new GenericArgumentContext(KlassInst, MethodInst);
            return gac.Resolve(Method.GetParam(index));
        }
