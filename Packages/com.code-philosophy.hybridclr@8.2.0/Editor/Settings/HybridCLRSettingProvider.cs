...
namespace HybridCLR.Editor.Settings
{
    public class HybridCLRSettingsProvider : SettingsProvider
    {
        ...
        private SerializedProperty _injectRuleFiles;
        ...
        private SerializedProperty _encryptionSettings;
        ...
        private void InitGUI()
        {
            ...
            _injectRuleFiles = _serializedObject.FindProperty("injectRuleFiles");
            ...
            _encryptionSettings = _serializedObject.FindProperty("encryptionSettings");
        }
        ...
        public override void OnGUI(string searchContext)
        {
            using (CreateSettingsWindowGUIScope())
            {
                ...
                EditorGUILayout.PropertyField(_injectRuleFiles);
                ...
                EditorGUILayout.PropertyField(_encryptionSettings);
