...
namespace HybridCLR.Editor.Il2CppDef
{
    public class Il2CppDefGenerator
    {
...
#if UNITY_2023_1_OR_NEWER && !TUANJIE_2022_3_OR_NEWER
            // use il2cpp of 2020.3.60 to generate cpp code, so current version is meaningless.
            // we pretend it's 6000.3.99
            minorVer1 = 3;
            minorVer2 = 99;
#endif
        ...
        private void GenerateDHEAssemblies()
        {
            ...
            {
                DifferentialHybridAssemblyList = (HybridCLRSettings.Instance.differentialHybridAssemblies ?? Array.Empty<string>()).ToList(),
