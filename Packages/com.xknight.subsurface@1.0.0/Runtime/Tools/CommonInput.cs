...
namespace XKnight.TA.SSS
{
    ...
    public unsafe struct ShaderVariableDiffusion
    {
        //最大的配置为16个，否则会越界
        public fixed float ShapeParamsAndFreePath[16 * 4];
        public fixed float TransmissionTintAndFresnel[16 * 4];
        public fixed float WorldScaleAndMaxRadiusAndThicknessRemaps[16 * 4];
        
        public fixed uint HashAndShadowStrenthAndThickOffset[16 * 4];
        public uint DiffusionParametersCount;
