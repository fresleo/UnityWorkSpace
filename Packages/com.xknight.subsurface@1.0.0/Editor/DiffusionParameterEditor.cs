//<summary>
//  SubsurfaceScatteringCustomPassDrawer.cs
//  author: calvin
//  date: 2026-06-20
//  description: DiffusionParameter资产编辑器面板
//</summary>
using System;
using UnityEditor;
using UnityEngine;
...
namespace XKnight.TA.SSS
{
    ...
    public sealed class DiffusionParameterEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.Slider(Fresnel0Prop, 0f, 1f, _styles.Fresnel0Prop);
        ...
        private void DrawTransmistPreview(DiffusionParameter asset)
        {
            ...
            mat.SetVector("_ShapeParams", asset.InputShape);
