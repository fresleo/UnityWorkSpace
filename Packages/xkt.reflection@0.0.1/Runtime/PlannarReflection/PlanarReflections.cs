...
namespace XKnight.Reflection.Runtime
{
    ...
    public class PlanarReflections : MonoBehaviour
    {
        ...
        private readonly int _planarReflectionTextureId = Shader.PropertyToID("_PlanarReflectionTextureV2");
        private readonly int _planarReflectionTexture2Id = Shader.PropertyToID("_PlanarReflectionTextureV3");
        ...
        private void PlanarReflectionTexture(Camera cam)
        {
            ...
            {
                var res = ReflectionResolution(cam, XKnightRenderPipeline.asset.renderScale);
        ...
        private void ExecutePlanarReflections(ScriptableRenderContext context, Camera camera)
        {
            ...
            XKnightRenderPipeline.RenderSingleCamera(context, _reflectionCamera);

            data.Restore();
            if (m_settings.flipX)
            {
                Shader.SetGlobalTexture(_planarReflectionTexture2Id, _reflectionTexture);
            }
            else
            {
