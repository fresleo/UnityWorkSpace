...
{
    public class CelestialsCalculations
    {
        ...
        const float k_HalfPI = 1.570796f;
        ...
        /// Return Hour - UTC.
        /// </summary>
        float Hour_UTC_Apply { get { return (float)DateTime.TimeOfDay.TotalHours - UTC; } }

        /// <summary>
        /// Return latitude in radians.
        /// </summary>
        float Latitude_Rad { get { return Mathf.Deg2Rad * Latitude; } }
        ...
        /// </summary>
        float Oblecl { get { return Mathf.Deg2Rad * (23.4393f - 3.563e-7f * TimeScale); } }
        ...
        /// </summary>
        OrbitalElements GetSunOrbitalElements
        {
            get
            {
                ...
                elements.M = Rev(elements.M); // Normalize M degrees.

                return elements;
            }
        }

        OrbitalElements GetMoonOrbitalElements
        {
            get
            {
                OrbitalElements elements = new OrbitalElements()
                ...
                // Normalize elements.
                elements.N = Rev(elements.N);
                elements.w = Rev(elements.w);
        ...
        public Vector3 GetSunCoords()
        {
            ...
            var SunOrbitalElements = GetSunOrbitalElements;
            ...
            m_SideralTime = GMST0 + Hour_UTC_Apply + Longitude / 15;
        ...
        public Vector3 GetMoonCoords()
        {
            ...
            var MoonOrbitalElements = GetMoonOrbitalElements;
