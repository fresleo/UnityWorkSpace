...
{
    [HideInInspector] public Renderer LOD1;
    [HideInInspector] public Renderer LOD2;
    [HideInInspector] public Renderer LOD3;
    ...
    public void ActivateLODScrpt()
    {
        ...
        InvokeRepeating(nameof(AFLODScrpt), Random.Range(0, Interval), Interval);
    }
    ...
    public void ActivateLODLay()
    {
        ...
        InvokeRepeating(nameof(AFLODLay), Random.Range(0, Interval), Interval);
    }
