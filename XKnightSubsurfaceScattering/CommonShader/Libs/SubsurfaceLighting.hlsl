...
void EncodeIntoSSSBuffer(DirectSufsurfaceLighting sssData, out float4 outSSSBuffer)
{
    outSSSBuffer = float4(sssData.Albedo, PackFloatInt8bit(0, _DiffusionParameter, 16));
}
