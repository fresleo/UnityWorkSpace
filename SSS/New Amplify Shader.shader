	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 uv_SSSColor = packedInput.ase_texcoord5.xy * _SSSColor_ST.xy + _SSSColor_ST.zw;
				

				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;

				surfaceDescription.BaseColor = tex2D( _SSSColor, uv_SSSColor ).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_SSSColor = packedInput.ase_texcoord2.xy * _SSSColor_ST.xy + _SSSColor_ST.zw;
		...
		Pass
		{
					 ...
					 )
			{
				...
				float2 uv_SSSColor = packedInput.ase_texcoord7.xy * _SSSColor_ST.xy + _SSSColor_ST.zw;
...
/*ASEBEGIN
Version=19905
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;12;-400,0;Inherit;True;Property;_SSSColor;SSSColor;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
