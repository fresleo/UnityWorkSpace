Shader "XKnight/Particle/AirWallComposite"
{
    Properties
    {
        ...
        [Header(AirWall Mask)]
        [Toggle] _AirWallMaskOn ("开启 AirWall Mask", Float) = 0
        _AirWallRolePositionWS ("AirWall Role Position WS", Vector) = (0, 0, 0, 0)
        _AirWallFullVisibleDistance ("AirWall Full Visible Distance", Float) = 1
        _AirWallFullHiddenDistance ("AirWall Full Hidden Distance", Float) = 3
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "libs/AirWallCompositePass.hlsl"
            ENDHLSL
        }
    ...
    CustomEditor "VFX.AirWallCompositeInspector"
}