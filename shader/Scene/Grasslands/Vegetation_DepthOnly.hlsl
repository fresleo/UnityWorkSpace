#ifndef __VEGETATION_DEPTH_ONLY__
#define __VEGETATION_DEPTH_ONLY__
...
VertexOutput vert(VertexInput input)
{
    ...
    float4 transform916 = mul(GetWorldToObjectMatrix(),float4( ( RAYGlobalDirection * ( lerpResult1020 * input.color.r * ( ( _WindForce * 100 ) * RAYGlobalWindForce ) ) ) , 0 ));
