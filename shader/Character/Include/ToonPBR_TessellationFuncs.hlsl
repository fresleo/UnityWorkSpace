#ifndef __TOONPBR_TESSELLATION_FUNCS__
#define __TOONPBR_TESSELLATION_FUNCS__
...
// 曲面细分评估函数 
[domain("tri")]
Varyings DomainFunction(TessellationFactors factors, OutputPatch<VertexControl, 3> patch, float3 barycentricCoordinates : SV_DomainLocation)
{
    Attributes o = (Attributes)0;
    o = PatchToOutput(patch, barycentricCoordinates);
    ...
    return VertexFunction(o); // 最后调用一下原始的顶点函数
}

#endif // __TOONPBR_TESSELLATION_FUNCS__
